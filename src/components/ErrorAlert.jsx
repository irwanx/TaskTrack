    ...
    return (
        <div className='absolute top-3 right-0 left-0'>
            <div className={`flex items-center justify-center backdrop-filter backdrop-blur-sm ${visible ? 'visible' : 'hidden'}`} role="alert">
                <div className={`flex gap-3 items-center justify-between  border border-red-700 text-red-700 dark:text-gray-50 px-4 py-3 rounded dark:bg-red-950 bg-gray-50 transition-all ease-in-out`}>
                    ...
                    <button onClick={handleClose} className={`focus:outline-none dark:text-gray-200 dark:hover:text-red-200 text-red-500 hover:text-red-700 transition-all ease-in-out`}>
